...
class TimeLordTests: XCTestCase {
    ...
    func testExample() {
        ...
        let fff = NSDate.NSDateFromString("sdfds", inFormat: "we")
        XCTAssertNil(fff, "")
    ...
    func testDateUnitGetter(){
        let tmDateInDefaultFormat = NSDate.NSDateFromString("2016-01-08 13:38:00")
    ...
    func testInitFromDateUnit(){
        ...
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 14, minute: 25, second: 00, timeZone: NSTimeZone(abbreviation: "KRAT"))
        XCTAssertEqual(tm1!.toString(), "2016-01-08 14:25:00")
        
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 10, minute: 25, second: 00, timeZone: NSTimeZone(abbreviation: "MSK"))
        XCTAssertEqual(tm2!.toString(NSTimeZone(abbreviation: "MSK")), "2016-01-08 10:25:00")
        XCTAssertEqual(tm1, tm2)
        
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 14, minute: 25, second: 00)
    ...
    func testInitFromString(){
        ...
        let tmDateInDefaultFormat = NSDate.NSDateFromString("2016-01-08 13:38:00")
        let tmDateInCustomFormat = NSDate.NSDateFromString("2016-01-08 13:38:00", inFormat: "yyyy-MM-dd HH:mm:ss")
        let tmDateInCustomFormatAndTimeZone = NSDate.NSDateFromString("2016-01-08 09:38:00", inFormat: "yyyy-MM-dd HH:mm:ss", timeZone: NSTimeZone(abbreviation: "MSK"))
    ...
    func testInitFormKeyWord(){
        let nsNow = NSDate()
        let tmNow = NSDate.NSDateAtKeyWord(.Now)
        let dateformater = NSDateFormatter()
        ...
        let tmYesterday = NSDate.NSDateAtKeyWord(.Yesterday)
    ...
    func testToString(){
        let tm = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 00, second: 00)
    ...
    func testTimeString(){
        let tm = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 40)
    ...
    func testBetween(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 20, minute: 25, second: 40)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 22, minute: 25, second: 40)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 24, minute: 25, second: 40)
    ...
    func testClosest(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 17, minute: 25, second: 00)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 20, minute: 25, second: 00)
    ...
    func testIsWeekend(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 17, minute: 25, second: 00)
    ...
    func testIsLeapYear(){
        let leapYear = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 10, minute: 25, second: 00)
        let notLeapYear = NSDate.NSDateFromYear(2015, month: 01, day: 09, hour: 17, minute: 25, second: 00)
    ...
    func testIsSameDay(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 17, minute: 25, second: 00)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 20, minute: 25, second: 00)
    ...
    func testIsSunday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 17, minute: 25, second: 00)
    ...
    func testIsMonday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 04, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 06, hour: 17, minute: 25, second: 00)
    ...
    func testIsTuesday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 05, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 17, minute: 25, second: 00)
    ...
    func testIsWednesday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 06, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 11, hour: 17, minute: 25, second: 00)
    ...
    func testIsThursday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 07, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 12, hour: 17, minute: 25, second: 00)
    ...
    func testIsFriday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 13, hour: 17, minute: 25, second: 00)
    ...
    func testIsSaturday(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 10, minute: 25, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 14, hour: 17, minute: 25, second: 00)
    ...
    func testAddYears(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2017, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm3 = NSDate.NSDateFromYear(2027, month: 01, day: 08, hour: 23, minute: 25, second: 11)
    ...
    func testAddMonths(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 02, day: 08, hour: 23, minute: 25, second: 11)
        let tm3 = NSDate.NSDateFromYear(2016, month: 10, day: 08, hour: 23, minute: 25, second: 11)
    ...
    func testAddDays(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 23, minute: 25, second: 11)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 19, hour: 23, minute: 25, second: 11)
    ...
    func testAddHours(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 2, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 3, minute: 25, second: 11)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 17, minute: 25, second: 11)
    ...
    func testAddMinutes(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 00, minute: 05, second: 11)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 40, second: 11)
    ...
    func testSubMinutes(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 26, second: 11)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 40, second: 11)
    ...
    func testAddSecond(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 12)
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 26)
    ...
    func testDiffInYears(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2040, month: 01, day: 08, hour: 23, minute: 25, second: 57)
        XCTAssertEqual(tm2!.diffInYears(tm1!), 24)
        XCTAssertEqual(tm2!.diffInYears(tm1!, absoluteValue: false), -24)
    }
    
    func testDiffInMonths(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 20, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 02, day: 21, hour: 23, minute: 25, second: 57)
        XCTAssertEqual(tm2!.diffInMonths(tm1!), 1)
        XCTAssertEqual(tm2!.diffInMonths(tm1!, absoluteValue: false), -1)
    }
    
    func testDiffInWeeks(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 01, hour: 20, minute: 25, second: 25)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 16, hour: 21, minute: 26, second: 30)
    ...
    func testDiffInDays(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 20, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 02, day: 08, hour: 23, minute: 25, second: 57)
        XCTAssertEqual(tm2!.diffInDays(tm1!), 19)
        XCTAssertEqual(tm2!.diffInDays(tm1!, absoluteValue: false), -19)
    }
    
    func testDiffInHours(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 20, hour: 20, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 21, hour: 11, minute: 25, second: 57)
    ...
    func testDiffInMinutes(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 20, hour: 20, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 20, hour: 21, minute: 30, second: 57)
    ...
    func testDiffInSeconds(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 11)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 08, hour: 23, minute: 25, second: 57)
    ...
    func testStartOfDay(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.startOfDay()
    ...
    func testEndOfDay(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.endOfDay()
        XCTAssertEqual(nsDate, tmDate)
    }
    ...
    func testStartOfMonth(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.startOfMonth()
        XCTAssertEqual(nsDate, tmDate)
    }
    ...
    func testEndOfMonth(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.endOfMonth()
        XCTAssertEqual(nsDate, tmDate)
    }
    ...
    func testStartOfYear(){
        ...
        dateFormatter.dateFormat = "yyyy-MM-dd HH:mm:ss"
        let nsDate = dateFormatter.dateFromString("2016-01-01 00:00:00")
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.startOfYear()
        XCTAssertEqual(nsDate, tmDate)
    }
    ...
    func testEndOfYear(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.endOfYear()
        XCTAssertEqual(nsDate, tmDate)
    }
    ...
    func testNext(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.next()
        XCTAssertEqual(nsDate, tmDate)
    }
    ...
    func testPrevious(){
        ...
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 10, hour: 22, minute: 11, second: 11)!.previous()
        XCTAssertEqual(nsDate, tmDate)
    }
    
    func testAverage(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 01, hour: 02, minute: 30, second: 00)
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 02, hour: 10, minute: 30, second: 00)
    ...
    func testCompare(){
        let tm1 = NSDate.NSDateFromYear(2016, month: 01, day: 01, hour: 02, minute: 30, second: 00)!
        let tm2 = NSDate.NSDateFromYear(2016, month: 01, day: 01, hour: 02, minute: 30, second: 00)!
        let tm3 = NSDate.NSDateFromYear(2016, month: 01, day: 02, hour: 18, minute: 30, second: 45)!
        let tm4 = NSDate.NSDateFromYear(2016, month: 01, day: 02, hour: 18, minute: 35, second: 45)!
    ...
    func testHashable(){
        ...
        dateFormatter.dateFormat = "yyyy-MM-dd HH:mm:ss"
        let nsDate = dateFormatter.dateFromString("2016-01-09 22:11:11")
        let tmDate = NSDate.NSDateFromYear(2016, month: 01, day: 09, hour: 22, minute: 11, second: 11)
